...
# Flights
lcf_filepath = 'LCFS/'
flight_filepath = 'Travel_Data/Overseas/No_trips/'


lcf_years = ['2007', '2008', '2009', '2010', '2011', '2012', '2013', '2014', '2015-2016', '2016-2017', '2017-2018']
years = [int(year[:4]) for year in lcf_years]

flight_lookup = pd.read_excel('LCFS/Controls/Physical Unit Coding.xlsx', Sheet_Name='Flights')
...
# save to file
writer = pd.ExcelWriter('LCFS/Controls/flights.xlsx')
for year in years:
