...
#############
    ...
    meta = pickle.load(open(eval("r'" + data_directory + "raw/UKMRIO_2021/meta.p'"), "rb" ))
    ...
    concs_dict = pd.read_excel(eval("r'" + data_directory + "raw/Concordances/COICOP_LCF_concs_2021.xlsx'"), sheet_name=None, index_col=0)
    concs_dict2 = pd.read_excel(eval("r'" + data_directory + "raw/Concordances/ONS_to_COICOP_LCF_concs_2021.xlsx'"), sheet_name=None, index_col=0)
...
#######################
    ...
    for data in ['ghg', 'uk_ghg_direct', 'S', 'U', 'Y']:
        ukmrio[data] = pickle.load(open(eval("r'" + data_directory + "raw/UKMRIO_2021/" + data + ".p'"), "rb" ))
        #means[data] = {}
        #for year in years:
    ...
    #tax = np.multiply(concs_dict2['vat'].iloc[:,0], concs_dict['vat'].iloc[:,1])
